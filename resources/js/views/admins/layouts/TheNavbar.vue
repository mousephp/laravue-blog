...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i class="fa fa-user nav-icon"></i> {{currentUser['name']}}
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <router-link to="/admin/profile" class="dropdown-item">
                    <i class="fas fa-user-tie nav-icon mr-2"></i> Profile
                </router-link>
                <router-link to="/admin/setting" class="dropdown-item">
                    <i class="fas fa-cog nav-icon mr-2"></i> Setting
                </router-link>
                <a href="javascript:void(0)" class="dropdown-item" v-on:click="logout"> 
                    <i class="fas fa-power-off nav-icon mr-2"></i> Logout
                </a>
            </div>
        </li>
